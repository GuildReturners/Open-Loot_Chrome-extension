...
function getSale(nftData: ItemLocalStorage[]) {
  ...
  nftData.map(nft => {
    if (nft.ownershipStatus == "Sold") {
      sold.value = sold.value + nft.soldPrice

      sold.nft = sold.nft + 1
      switch (nft.rarity) {
        case 'uncommon':
          sold.uncommon.value = sold.uncommon.value + nft.soldPrice

          sold.uncommon.nft = sold.uncommon.nft + 1
          break;
        case 'rare':
          sold.rare.value = sold.rare.value + nft.soldPrice
          sold.rare.nft = sold.rare.nft + 1
          break;
        case 'epic':
          sold.epic.value = sold.epic.value + nft.soldPrice
          sold.epic.nft = sold.epic.nft + 1
          break;
        case 'legendary':
          sold.legendary.value = sold.legendary.value + nft.soldPrice
          sold.legendary.nft = sold.legendary.nft + 1
          break;
        case 'exalted':
          sold.exalted.value = sold.exalted.value + nft.soldPrice
